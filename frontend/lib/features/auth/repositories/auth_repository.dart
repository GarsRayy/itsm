...
class AuthRepository {
  ...
  /// Sign in with Google (SSO) as required by ISO 27001 Zero Trust.
  Future<bool> signInWithGoogle() async {
    return await _auth.signInWithOAuth(
      OAuthProvider.google,
      redirectTo: 'io.supabase.flutter://login-callback/',
      queryParams: {
        'hd': 'student.itera.ac.id', // Membatasi login hanya untuk domain ini
      },
    );
  }
  ...
  ///
  /// The `user_profiles` table is expected to have columns:
  ...
  Future<AppUser> getCurrentAppUser() async {
    ...
    // Try fetching from user_profiles table

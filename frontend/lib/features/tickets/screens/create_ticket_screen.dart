...
class _CreateTicketScreenState extends ConsumerState<CreateTicketScreen> {
  ...
  final _orgCtrl = TextEditingController(text: 'Internal ITSM');
  String _selectedOrigin = 'portal';
  String _selectedImpact = 'person';
    ...
    try {
      ...
      final ticket = await repo.createManualTicket(
        ...
        title: _titleCtrl.text.trim().isNotEmpty 
            ...
            : '[${_selectedItem!.code}] ${_selectedItem!.name}',
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildSectionHeader('General Information', delay: 100),
                  ...
                  _buildSectionHeader('More Information', delay: 300),
                  const SizedBox(height: AppSizes.spacing12),
                  ...
                  if (_selectedItem != null) const SizedBox(height: AppSizes.spacing24),
                  
                  // ── Section 3: Qualification ─────────────────
                  if (_selectedItem != null) ...[
                    _buildSectionHeader('Qualification', delay: 500),
                    const SizedBox(height: AppSizes.spacing12),
      ...
      child: Column(
        ...
        children: [
          TextFormField(
            ...
            decoration: const InputDecoration(labelText: 'Organization', border: InputBorder.none),
          ...
          DropdownButtonFormField<UserProfile>(
            ...
            decoration: const InputDecoration(
              ...
              icon: Icon(Icons.person_search_rounded, color: AppColors.textHint),
            ),
          ...
          DropdownButtonFormField<String>(
            ...
            dropdownColor: AppColors.surfaceLight,
            decoration: const InputDecoration(labelText: 'Origin', border: InputBorder.none),
            items: const [
            ...
            onChanged: (val) => setState(() => _selectedOrigin = val ?? 'portal'),
          ),
          const Divider(color: AppColors.surfaceLight),
          TextFormField(
      ...
      child: Column(
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            dropdownColor: AppColors.surfaceLight,
            decoration: const InputDecoration(labelText: 'Impact', border: InputBorder.none),
            items: const [
              DropdownMenuItem(value: 'department', child: Text('A department')),
              DropdownMenuItem(value: 'person', child: Text('A person')),
              DropdownMenuItem(value: 'service', child: Text('A service')),
              DropdownMenuItem(value: 'enterprise', child: Text('Enterprise')),
            ],
            onChanged: (val) => setState(() => _selectedImpact = val ?? 'person'),
          ),
          const Divider(color: AppColors.surfaceLight),
          DropdownButtonFormField<String>(
            initialValue: _selectedUrgency,
            dropdownColor: AppColors.surfaceLight,
            decoration: const InputDecoration(labelText: 'Urgency', border: InputBorder.none),
            items: const [
            ...
            onChanged: (val) => setState(() => _selectedUrgency = val ?? 'medium'),
          ),
        ],
      ),
    );
